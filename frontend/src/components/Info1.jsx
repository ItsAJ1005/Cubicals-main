  ...
  return (
    <div className='h-screen w-full'>
        <div className='top text-white mx-[8vw] '>
            ...
            Empowering everyone with <u>opportunities</u> - explore accessible and inclusive job listings tailored for all...
            </div>
        </div>
            ...
            <div className='text-xl font-semibold'>
                <div className='flex gap-[8vw] '>
                    ...
                    <div className='flex flex-col gap-[2rem] w-[15vw]' data-aos='fade-in'>
                        ...
                        <div className='flex gap-3 glass-sm '>
                            <img src='src/assets/job-seeker-50.png' className='h-[20px] mt-[4px]'/> <div className='flex '>Grow & Upskill With Us</div>
                        </div>
                    ...
                    <div className='flex flex-col gap-[2rem] w-[15vw]' data-aos='fade-in'>
                        <div className='flex gap-3 glass-sm '>
                            <img src='src/assets/job-seeker-50.png' className='h-[20px] mt-[4px]'/> <div className='flex '>Job Alerts To Stay Updated</div>
                        </div>
                        <div className='flex gap-3 glass-sm '>
                            <img src='src/assets/job-seeker-50.png' className='h-[20px] mt-[4px]'/> <div className='flex '>Stay Conneted With Experts</div>
                        </div>
                        <div className='flex gap-3 glass-sm '>
                            <img src='src/assets/job-seeker-50.png' className='h-[20px] mt-[4px]'/> <div className='flex '>Experience Sharing Communities</div>
                        </div>
            ...
            <div>
                <div className='green-glow-card bg-gradient-to-r from-green-400 via-green-500 to-green-600 h-[45vh] rounded-xl w-[40vw] relative -top-20'>
                    <div className='flex flex-row-reverse m-4'>
                        <HoverCard>
                            <HoverCardTrigger className='my-2 w-6 px-[5px] cursor-pointer bg-black rounded-full '>ⓘ</HoverCardTrigger>
                            <HoverCardContent>
                    ...
                    <div className='w-[20vw] text-white'>
                        <Command className='bg-black text-white shadow-sm shadow-zinc-900 mx-[17vh]'>
                            ...
                            <CommandList>
                                ...
                                <Link to='/profile'><CommandItem className='cursor-pointer'>⌘ Applications</CommandItem></Link>
                                <Link to='/jobs'><CommandItem  className='cursor-pointer'>⌘ Jobs</CommandItem></Link>
