      ...
      <main className='flex-grow pt-24 pb-32 px-4 sm:px-8 max-w-7xl mx-auto w-full'>
        ...
        <div className='text-center mb-16'>
          ...
          <p className='text-lg text-gray-300 max-w-3xl mx-auto'>
            Cubicles is committed to creating an inclusive and accessible job search platform for everyone. 
        ...
        <section className='mb-20'>
          ...
          <div className='bg-gradient-to-br from-gray-800 to-gray-900 rounded-2xl border border-gray-700 p-8'>
            ...
            <p className='mt-8 text-lg text-gray-300'>
              ...
              Cubicles provides the tools and community support to keep you motivated and on track.
            </p>
          </div>
        </section>
